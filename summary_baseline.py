...
def main_pipeline(llm):
    ...
    directory = './m2m_baseline/{}'.format(llm)  # set directory path
    full = []
    ...
    for root, _, files in os.walk(directory):
        for filename in files:  # loop through files in the current directory
            ...
            meaning_prompts = meaning_sheet.iloc[:,1:3]
    ...
    summary.to_csv("{}{}-baseline-general.csv".format(output_dir,llm), encoding='utf-8')
